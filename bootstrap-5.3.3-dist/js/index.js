document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function updateAnnouncements() {
        try {
            const announcements = await fetchCSV('SaseSite/CSV_info/Announcements.csv');
    ...
    async function updateEvents() {
        try {
            const events = await fetchCSV('SaseSite/CSV_info/UpcomingEvents.csv');
    ...
    async function updateCarousel() {
        try {
            const carousel = await fetchCSV('SaseSite/CSV_info/Carousel.csv');
